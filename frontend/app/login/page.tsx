      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="bg-[#1c1e2e] border border-[#2a2d3e] rounded-xl p-6 space-y-3">
          <a
            ...
            className="flex items-center justify-center gap-3 w-full bg-[#3ecf8e] text-[#0f1117] font-semibold py-2.5 px-4 rounded-lg hover:bg-[#34b87a] transition-colors"
          >
          ...
          <button
            onClick={handleGuest}
            className="w-full py-2.5 px-4 rounded-lg border border-[#2a2d3e] text-[#9ca3af] text-sm font-medium hover:border-[#3ecf8e]/40 hover:text-white transition-colors cursor-pointer"
          >
            Continue as Guest
          </button>
        </div>
